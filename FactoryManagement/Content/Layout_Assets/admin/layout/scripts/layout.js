...
var Layout = function () {
    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            ...
            if (body.hasClass('page-sidebar-fixed') || body.hasClass('page-sidebar-fix')) {   //added zubayed
            ...
            content.attr('style', 'min-height:' + windowHeight + 'px');
        }
    };
        ...
        $('.page-sidebar').on('click', 'li > a', function (e) {
            ...
            if (sub.is(":visible")) {
                ...
                sub.slideDown(slideSpeed, function () {
                    if (autoScroll === true && $('body').hasClass('page-sidebar-closed') === false) {
                        if ($('body').hasClass('page-sidebar-fixed') || $('body').hasClass('page-sidebar-fix')) {
                            menu.slimScroll({
                                'scrollTo': (the.position()).top
                            });
                        } else {
    ...
    var handleFixedSidebar = function () {
        ...
        if ($('.page-sidebar-fixed').size() === 0 && false) {   //added zubayed
            handleSidebarAndContentHeight();
            return;
        }

        if (Metronic.getViewPort().width >= resBreakpointMd || true) {   //added zubayed 3/1/17
